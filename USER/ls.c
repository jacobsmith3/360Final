...
int ls_file(char *fileName)     // lists a single file
{
    ...
    if ((sp->st_mode & 0xF000) == 0x8000)   // check if the file is a directory
        printf("%c", 'd');
    if ((sp->st_mode & 0xF000) == 0x4000)      // check if the file is a regular file
        printf("%c", '-');
    if ((sp->st_mode & 0xF000) == 0xA000)   // check if the file is a symbolic link
        printf("%c", 'l');
    ...
    if ((sp->st_mode & 0xF000)== 0xA000)   // if the file is a symbolic link
    {
